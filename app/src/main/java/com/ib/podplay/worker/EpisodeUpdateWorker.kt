    ...
    override suspend fun doWork(): Result = coroutineScope {
        val job = async{
            ...
            repo.updatePodcastEpisodes { podcastUpdates ->
                ...
                podcastUpdates.forEach { podcastUpdate -> displayNotification(podcastUpdate) }
            }
        }
        job.await()
        Result.success()
    ...
    private fun displayNotification(podcastInfo: PodcastRepo.PodcastUpdateInfo){
        ...
        EPISODE_CHANNEL_ID)
            ...
            .setContentText(applicationContext.getString(
                R.string.episode_notification_text,podcastInfo.newCount,podcastInfo.name))
